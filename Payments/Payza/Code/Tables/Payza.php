...
namespace Payments\Payments\Payza\Code\Tables;
 ...
 * Payza
 *
 * @ORM\Table(name="payments_payments_payza", indexes={@ORM\Index(name="created_by_index", columns={"created_by"}), @ORM\Index(name="modified_by_index", columns={"modified_by"})})
 * @ORM\Entity
