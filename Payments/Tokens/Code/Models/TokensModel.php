...
namespace Payments\Payments\Tokens\Code\Models;
...
class TokensModel extends PaymentsModel {
    ...
    public function updateToken($token_obj) {
        ...
        $factory->saveRecord('#__payments_tokens', $token_obj);
    }
    ...
    public function getToken($token) {
        ...
        $query->from('#__payments_tokens', 'ft');
        $query->leftJoin('ft', '#__payments_tokens_types', 'ftt', 'ftt.id = ft.type_id');
